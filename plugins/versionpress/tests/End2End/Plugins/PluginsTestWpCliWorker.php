...
class PluginsTestWpCliWorker extends WpCliWorker implements IPluginsTestWorker
{
    ...
    {
        $this->wpAutomation->runWpCliCommand('plugin', 'install', [$this->pluginInfo['zipfile']]);
    }
    ...
    {
        $this->wpAutomation->runWpCliCommand('plugin', 'activate', [$this->pluginInfo['url-fragment']]);
    }
    ...
    {
        $this->wpAutomation->runWpCliCommand('plugin', 'deactivate', [$this->pluginInfo['url-fragment']]);
    }
    ...
    {
        $this->wpAutomation->runWpCliCommand('plugin', 'delete', [$this->pluginInfo['url-fragment']]);
    }
    ...
    public function installTwoPlugins()
    {
        $this->wpAutomation->runWpCliCommand(
            'plugin',
            'install',
            [$this->pluginInfo['zipfile'], $this->secondPluginInfo['zipfile']]
        );
    }
