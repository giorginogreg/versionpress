...
abstract class PostTypeTestWpCliWorker extends WpCliWorker implements IPostTypeTestWorker {
    ...
    public function prepare_quickEditPost() {
        throw new \PHPUnit\Framework\SkippedTestError('There is nothing like quick edit in the WP-CLI');
    }
    ...
    public function prepare_previewDraft() {
        throw new \PHPUnit\Framework\SkippedTestError('There is nothing like preview in the WP-CLI');
    }
