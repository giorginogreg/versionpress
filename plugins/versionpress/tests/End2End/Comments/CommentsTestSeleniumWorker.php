...
class CommentsTestSeleniumWorker extends SeleniumWorker implements ICommentsTestWorker {
    ...
    public function prepare_createSpamComment() {
        throw new \PHPUnit\Framework\SkippedTestError('It\'s too difficult to create spam comment via Selenium');
    }
    ...
    public function prepare_editTwoComments() {
        throw new \PHPUnit\Framework\SkippedTestError('There is no way to edit more comments at once using selenium');
    }
