...
class MediaTestSeleniumWorker extends SeleniumWorker implements IMediaTestWorker {
    ...
    public function prepare_editFileName() {
        throw new \PHPUnit\Framework\SkippedTestError("It's impossible to submit the form from Selenium. I tried everything. Maybe some future me will be more lucky.");
    }
