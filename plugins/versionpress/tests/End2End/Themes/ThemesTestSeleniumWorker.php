...
class ThemesTestSeleniumWorker extends SeleniumWorker implements IThemesTestWorker {
    ...
    public function prepare_uploadTwoThemes() {
        throw new \PHPUnit\Framework\SkippedTestError('There is no way to upload more themes at once using selenium');
    }
    ...
    public function prepare_deleteTwoThemes() {
        throw new \PHPUnit\Framework\SkippedTestError('There is no way to delete more themes at once using selenium');
    }
